export class ProfitService {
  ...
  getPage(pageNum = 1, searchForm) {
    ...
    if(searchForm && searchForm.doSearch) {
      return self.$http({
        url: self.cfg.api.profit.search.url,
        method: self.cfg.api.profit.search.type,
        params: {
          pageNum: pageNum,
      ...
      return self.$http({
        url: self.cfg.api.profit.list.url,
        method: self.cfg.api.profit.list.type,
        params: {
          pageNum: pageNum
        }
      }).then((response) => {
  ...
  getDetail(id) {
    ...
    return self.$http({
      url: self.cfg.api.profit.detail.url,
      method: self.cfg.api.profit.detail.type,
      params: {
        id: id
      }
    }).then((response) => {
